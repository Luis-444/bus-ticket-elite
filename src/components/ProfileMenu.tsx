...
export default function ProfileMenu() {
    ...
    return (
        <section className="absolute bottom-0 right-0 w-full flex justify-end">
            <UserCircleIcon onClick={ e => setMenu(!menu) } className="w-16 m-2 hover:scale-110 cursor-pointer text-primary-hover hover:text-white transition-all duration-300" />
            {menu && (
